...
$ psql -h hosting-address-of-blog.eu-central-1.rds.amazonaws.com --port=5432 -U adnankaya -d db_blog < project_blog_DUMP.sql
...
# 3. clone the project 
$ gh repo clone adnankaya/project_blog
...
LoadModule wsgi_module "/home/ubuntu/project_blog/venv/lib/python3.8/site-packages/mod_wsgi/server/mod_wsgi-py36.cpython-36m-x86_64-linux-gnu.so"
WSGIPythonHome "/home/ubuntu/project_blog/venv"
...
# 14. create a new conf file for project_blog
$ sudo cp 000-default.conf project_blog.conf
# 15. open and edit project_blog.conf
$ sudo nano project_blog.conf
############### inside nano ###############################
<VirtualHost *:80>
#	ServerName localhost
#	ServerAdmin webmaster@localhost

	Alias /static /home/ubuntu/project_blog/staticroot
	<Directory /home/ubuntu/project_blog/staticroot>
		Require all granted
	</Directory>
# We use AWS S3 buckets
	#Alias /media /home/ubuntu/project_blog/media
	#<Directory /home/ubuntu/project_blog/media>
	#	Require all granted
	#</Directory>

	<Directory /home/ubuntu/project_blog/src>
        <Files wsgi.py>
            Require all granted
        </Files>
	</Directory>

	WSGIDaemonProcess www.project_blog.org python-home=/home/ubuntu/project_blog/venv python-path=/home/ubuntu/project_blog
	WSGIProcessGroup www.project_blog.org
	WSGIScriptAlias / /home/ubuntu/project_blog/src/wsgi.py
...
(venv) ubuntu@adnankaya:~/project_blog$ python manage.py collectstatic
...
# [ LAST ] disable default apache conf and enable project_blog.conf and reload the apache
$ sudo a2dissite 000-default.conf 
$ sudo a2ensite project_blog.conf 
$ sudo systemctl reload apache2
```
